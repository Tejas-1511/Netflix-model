        ...
        isHovered && (
          <div className="hover">
            <div className="image-video-container">
              ...
              <video src={video} muted autoPlay loop onClick={() => navigate("/player")} />
            </div>
            <div className="info-container flex column">
              ...
              <div className="icons flex j-between">
                <div className="controls flex">
                  ...
                  {
                    isLiked ? (<BsCheck title="Remove from List" onClick={() => dispatch(removeFromLikedMovies({ movieId: movieData.id, email }))} />) : (<AiOutlinePlus title='Add to my List' onClick={addToLike} />)
                  }
                </div>
                <div className="info">
